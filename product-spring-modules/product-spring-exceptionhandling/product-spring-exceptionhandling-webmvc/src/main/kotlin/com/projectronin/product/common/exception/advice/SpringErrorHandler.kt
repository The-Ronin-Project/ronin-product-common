...
class SpringErrorHandler(@Autowired override val responseEntityConstructor: ErrorHandlingResponseEntityConstructor) : ResponseEntityExceptionHandler(), ErrorHandlingResponseEntityBuilder<Throwable> {
