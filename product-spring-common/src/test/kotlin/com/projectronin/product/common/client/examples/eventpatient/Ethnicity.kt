...
/**
 * US Core ethnicity classification
 *
 */
...
class Ethnicity {
    ...
    override fun toString(): String {
        ...
        sb.append(Ethnicity::class.java.name).append('@').append(Integer.toHexString(System.identityHashCode(this)))
            .append('[')
